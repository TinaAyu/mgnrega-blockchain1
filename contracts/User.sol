...
contract User {
  ...
  function User() {
    ...
    userTypes.push("GPC");
    userTypes.push("Wager");

    places.push("Silk board");
    places.push("Marathalli");
    places.push("Sarjapura");
  }
  ...
  function authenticateUserWithAddress(address _userAddress, string _password) constant returns(bool) {
